...
<html>
	...
	<head>
		<title>Welcome  To Social Network - Sign up, Log in, Post </title>
...
<?php
	include("includes/database.php");
			$comment=mySQLi_query($conn,"SELECT * from comments where post_id='$post_id' order by post_id DESC") or die("Error Occurred: " .$conn->error);
...
?>
		 ...
		 <form  method="POST">			
			<div class="comment-area">
						...
						<?php $image=mysqli_query($conn,"select * from user where user_id='$id'")or  die("Error Occurred: " . $conn->error);;
...
<?php
	...
	if (isset($_POST['post_comment']))
	{
...

		{
			...
			or  die("Error Occurred: " . $conn->error);
